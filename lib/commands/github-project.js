...
async function githubProjectCommand(action = 'setup', options = {}) {
  if (action === 'setup') {
    ...
    console.log(chalk.gray('  ux-ingka github project setup  - Configure project integration'));
    console.log(chalk.gray('  ux-ingka github project test   - Test project assignment\n'));
    process.exit(1);
  }
}
...
async function setupGitHubProject(options = {}) {
  ...
  if (!isOrgRepo) {
    ...
    if (setupPAT) {
      ...
      console.log(chalk.gray('2. Give it a descriptive name: "UX Ingka Kit - Project Access"'));
...
`;
  ...
  console.log(chalk.cyan('     ux-ingka github project test\n'));
...
async function testGitHubProject(options = {}) {
  ...
  if (!await fs.pathExists(envPath)) {
    ...
    console.log(chalk.cyan('  ux-ingka github project setup\n'));
    process.exit(1);
  }
