 ...
 * Manages both local (.ux-ingkarc.json in project) and global (~/.ux-ingkarc.json) configs
 */

const CONFIG_FILE_NAME = '.ux-ingkarc.json';
 ...
 * @returns {string} Path to local .ux-ingkarc.json
 */
